 ...
 * @author Hrckok
 */
public class SOUcitajSveProfesoreUslov extends AbstractSO {
    ...
    protected void execute(AbstractDomainObject ado) throws Exception {
        // Izvlačimo studente
        List<AbstractDomainObject> rezultatProfesori = DBBroker.getInstance().select(ado);
    ...
    public List<Profesor> getListaProfesoraUslov() {
